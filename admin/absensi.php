...
$no = 1;
$query = mysqli_query($conn, "SELECT * FROM absensi ORDER BY nama ASC");
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="container-fluid">
            <!-- Page Heading -->
            <div class="clearfix">
              <h1 class="h3 mb-4 text-gray-800 float-left">Data Absensi Karyawan</h1>
                    ...
                    <form action="#" method="POST">
                        ...
                        <?php
                            if(isset($_POST['btn_tgl'])){
                                $tgl = $_POST['tgl'];
                                $query = mysqli_query($conn, "SELECT * FROM absensi WHERE tgl = '$tgl' ORDER BY nama ASC");
